...
https://dev.axiomide.com/marketplace/christiangeorgelucas/diff-tools@0.7.0
...
```bash
axiom invoke christiangeorgelucas/diff-tools/Diff --input '{ ... }'
```

**Call it over HTTP.**

```bash
curl -X POST https://api.axiomide.com/invocations/v1/nodes/christiangeorgelucas/diff-tools/0.7.0/Diff \
...
> `axiom inspect node christiangeorgelucas/diff-tools/Diff`.
